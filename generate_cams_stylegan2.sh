...
python generate_cams_dataset_stylegan2.py --dataset ffhq --network /home/khj/refactor/lang-seg/networks/ffhq-res256-mirror-paper256-noaug.pkl --save_path test --mask
